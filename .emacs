...
(defun my-color-theme ()
  "Color theme by rui, created 2009-10-24."
  (interactive)
  (color-theme-install
   '(my-color-theme
     ...
     (default ((t (:stipple nil :background "Grey15" :foreground "Grey" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 118 :width normal :foundry "unknown" :family "VL ゴシック"))))
     ...
     (completions-common-part ((t (:family "VL ゴシック" :foundry "unknown" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "Grey" :background "Grey15" :stipple nil :height 118))))
     ...
     (dropdown-list-face ((t (:family "VL ゴシック" :foundry "unknown" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :stipple nil :background "lightyellow" :foreground "black" :height 118))))
     (dropdown-list-selection-face ((t (:foreground "black" :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :width normal :foundry "unknown" :family "VL ゴシック" :background "purple" :height 118))))
