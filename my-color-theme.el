...
(custom-theme-set-faces
 ...
 '(region ((t (:background "#192C35"))))
 '(default ((t (:stipple nil :background "black" :foreground "light grey" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 140 :width normal :foundry "apple" :family "Inconsolata"))))
 ...
 '(css-property ((t (:bold t :foreground "pale turquoise" :weight bold))))
 '(css-selector ((t (:bold t :foreground "turquoise" :weight bold))))
